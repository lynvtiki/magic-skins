...
//
//        LOG(debug) << " transfer_asset " << it.key() << " " << it.value();
//
...
//
//
//TEST(LUA_CODE_GEN, mod_info) {
//
//    genetate(R"(E:\game\Steam\steamapps\common\Don't Starve Together)", "D:\\tmp_dir");
//
//}
//
//TEST(LUA_CODE_GEN, JSONTYUPE) {
//
//    AssertBuilder as(ModProxyPrefix);
