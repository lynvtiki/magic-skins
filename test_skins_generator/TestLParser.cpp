...
TEST(TEST_LUACODE_PARSER, skinprefabs_by_line) {
    static std::ifstream ifs("D:\\����\\scripts\\prefabs\\skinprefabs.lua");
    LParser::skinprefabs(ifs);
}

TEST(TEST_LUACODE_PARSER, prefabskins_by_line) {
    std::ifstream ifs("D:\\����\\scripts\\prefabskins.lua");
    LParser::prefabskins(ifs);
}

TEST(TEST_LUACODE_PARSER, skinsdefsdata_test_line) {
    std::ifstream ifs("D:\\����\\scripts\\skins_defs_data.lua");
...
TEST(TEST_LUACODE_PARSER, chinese_po_test_find_all) {
    std::ifstream ifs("D:\\����\\scripts\\languages\\chinese_s.po");
...
TEST(TEST_LUACODE_PARSER, test_render_skinprefabs) {
    std::ifstream ifs("D:\\����\\scripts\\prefabs\\skinprefabs.lua");
...
TEST(TEST_LUACODE_PARSER, test_clothing_curios) {
    std::ifstream ifs("D:\\����\\Local Collection Skins\\buildtool\\temp\\clothing.lua");
    int c_size = 200;
